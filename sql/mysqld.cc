...
SHOW_VAR com_status_vars[]= {
  ...
  {"create_temp_table",    (char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_CREATE_TEMP_TABLE]), SHOW_LONG_STATUS},
  ...
  {"drop_temp_table",      (char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_DROP_TEMP_TABLE]), SHOW_LONG_STATUS},
